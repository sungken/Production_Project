...
public class Toolkit {
	...
	/**
	 * 주어진 날짜 문자열의 유효성을 검사하는 메서드이다. 날짜가 지정된 형식인 "yyyy-MM-dd"에 부합하는지를 확인한다.
	 * 
	...
	/**
	 * 공지사항 삭제 예정일의 유효성을 검사하는 메서드이다. 공지사항을 작성할 때와 공지사항 데이터를 불러올 때 삭제일과 당일 날짜를 비교한다.
	 * 
	...
	/**
	 * 대리점이 주문서를 작성할 때 납기일을 자동으로 계산하기 위한 메서드이다. 현재 날짜를 기준으로 5일 후의 날짜를 계산하여 문자열로
	 * 반환한다.
	 * 
	...
	/**
	 * 전화번호의 유효성을 검사하는 메서드이다. 전화번호는 "-"를 포함한 12자 또는 13자 숫자만으로 구성되어야 한다.
	 * 
	...
	/**
	 * 주소의 유효성을 검사하는 메서드이다. 주소는 2자 이상 34자 이하의 한글, 숫자, 공백으로 구성될 수 있다.
	 * 
